...
def run_eval(args, ccot=False):
    ...
    for data in tqdm(dataset):
        ...
        cont,hist = model.generate(
            ...
            verbose=True,
            schedule='shift',
            remasking='entrophy', # posaware  low_confidence  margin  entrophy
        ...
        qs = generated_text + '\n\n' + qs + '\n' + "Answer with the option's letter from the given choices directly." # 0.7204
        # qs = qs + '\n\n' + generated_text + '\n' + "Answer with the option's letter from the given choices directly." # 0.7159
